package com.cloudwalk.shark.rule.util.invocationhandlers;

import com.cloudwalk.shark.rule.util.beans.RequestInfo;
import com.cloudwalk.shark.rule.util.beans.RestInfo;
import com.cloudwalk.shark.rule.util.http.GET;
import com.cloudwalk.shark.rule.util.http.Param;
import com.cloudwalk.shark.rule.util.interfaces.IRequestHandle;
