package com.cloudwalk.shark.rule.util;

import com.cloudwalk.shark.rule.util.beans.RestInfo;
import com.cloudwalk.shark.rule.util.http.GET;
import com.cloudwalk.shark.rule.util.http.Rest;
import com.cloudwalk.shark.rule.util.invocationhandlers.MyInvocationHandler;
