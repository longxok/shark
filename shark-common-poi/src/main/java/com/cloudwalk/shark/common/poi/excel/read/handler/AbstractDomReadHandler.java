...
import com.cloudwalk.shark.common.poi.excel.model.SheetData;
import com.cloudwalk.shark.common.poi.excel.model.Title;
import com.cloudwalk.shark.common.util.CollectionUtils;
...
public abstract class AbstractDomReadHandler<T> extends AbstractReadHandler<T> implements DomReadHandler<T> {
    ...
    @Override
    public final ReadResult<T> process(InputStream in) throws IOException, EncryptedDocumentException, InvalidFormatException {
    ...
    @Override
    public final ReadResult<T> process(File file) throws IOException, EncryptedDocumentException, InvalidFormatException {
