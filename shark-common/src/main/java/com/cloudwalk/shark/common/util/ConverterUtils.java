...
import com.cloudwalk.shark.common.converters.StringToBooleanConverter;
import com.cloudwalk.shark.common.converters.StringToDateConverter;
import com.cloudwalk.shark.common.converters.StringToNumberConverter;
...
public class ConverterUtils {
    ...
    static {
        ...
        DEFAULT_CONVERSION_SERVICE.addConverter(new StringToNumberConverter.StringToLongConverter());
        DEFAULT_CONVERSION_SERVICE.addConverter(new StringToNumberConverter.StringToIntegerConverter());
        DEFAULT_CONVERSION_SERVICE.addConverter(new StringToNumberConverter.StringToBigIntegerConverter());
    }
