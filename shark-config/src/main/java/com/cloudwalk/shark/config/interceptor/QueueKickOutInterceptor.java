 ...
 * 队列踢出
 */
public class QueueKickOutInterceptor extends AbstractAuthenticationInterceptor {
    /**
    ...
    public boolean isAccessAllowed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        User currentSession = (User)request.getAttribute("currentUser");
        ...
        try {
            ...
            while (deque.size() > maxSession) {
                ...
                try {
                    ...
                    User kickoutSession = bucket.get();
